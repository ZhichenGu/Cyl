// Compile this independent sketch as the controller for physical pushrods 5–8.
#define PUSHROD_SECOND_BOARD

/*
  ESP32 #2 — physical pushrods 5–8.  Keeps the original active-LOW relay pins:
  5=(GPIO13,14), 6=(16,17), 7=(18,19), 8=(25,26).
*/
#include <WiFi.h>
